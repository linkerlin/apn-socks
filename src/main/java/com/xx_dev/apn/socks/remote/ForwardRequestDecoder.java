...
/**
 * @author xmx
 * @version $Id: com.xx_dev.apn.socks.remote.ForwardRequestDecoder 2015-03-05 19:43 (xmx) Exp $
 */
public class ForwardRequestDecoder extends ReplayingDecoder<ForwardRequestDecoder.STATE> {
    private static final String name = "FORWARD_REQUEST_DECODER";
