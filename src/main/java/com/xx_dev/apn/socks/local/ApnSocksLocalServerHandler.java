...
public final class ApnSocksLocalServerHandler extends SimpleChannelInboundHandler<SocksRequest> {
    ...
    public void channelRead0(ChannelHandlerContext ctx, SocksRequest socksRequest) throws Exception {
        ...
        case INIT: {
            ...
            //ctx.pipeline().addAfter("log", "authRequstDecoder", new SocksAuthRequestDecoder());
